export const dataClinic = [
  {
    ...
    address: "53 Đặng Dung, Tân Định, Quận 1",
    description:
    ...
    contact: "Liên hệ: 096 669 48 39",
  },
  {
    title: "Phòng khám Pet Farm",
    image: "./images/event-custom.jpg",
    address: "366 Đường Cây Trâm, Phường 8, Q. Gò Vấp",
    description: "Phòng khám sạch sẽ, dịch vụ tốt, bác sĩ tận tâm",
    feature: [
      "Phòng khám sạch sẽ",
      "Điều trị phẫu thuật",
      "Trông nom thú cưng",
    ],
    contact: "Liên hệ: 090 983 67 77",
  },
  {
    title: "Phòng khám Family Bean",
    image: "./images/event-private.jpg",
    address: "46C Lê Hồng Phong, Phường 2, Quận 5",
    description:
